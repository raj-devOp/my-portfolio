<?php
//this code has been borrowed from coursework resources
class BobDemo {

    const DB_HOST = 'mysql.cms.gre.ac.uk';
    const DB_NAME = 'mdb_rg5319d';
    const DB_USER = 'rg5319d';
    const DB_PASSWORD = 'rg5319d';
