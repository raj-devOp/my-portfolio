...
if(isset($_POST['submit'])){
    ...
    if($stmt->execute()){
        $result = $stmt->get_result();
        if($result->num_rows>0){
            $msg = "<div class='alert alert-danger'>Book Already !</div>";
        } else {
...
<html lang="en">
  ...
  <body>  
      ...
      <div class="container">
          <h1 class="text-center">Book Date: <?php echo date('m/d/Y', strtotime($date)); ?></h1><hr>
          <div class="row">
              <div class="col-md-12">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Booking: <span id="slots"></span></h4>
      </div>
